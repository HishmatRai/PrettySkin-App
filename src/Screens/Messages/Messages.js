...
let PostData = [
  {
    ...
    postUserAddress: "New York, USA",
    postTime: "2m",
    postDes:
      "Contrary To Popular Belief, Lorem Ipsum Is Not Simply Random Text. It Has Roots In A Piece Of Classical Latin Literature From 45 BC, Making It Over 2000 Years Old. Richard Mcclintock, A Latin Professor At Hampden..... More",
    likeCounter: "1",
  },
  {
    postUserName: "John Smith",
                ...
                <View style={styles.card_main}>
                  <View style={styles._header_main}>
                    <View style={styles._prfile_main}>
                      <Image
                        source={require("./../../images/user_profile.png")}
                        style={styles.post_profile_image}
                      />
                    </View>
                    <View style={styles._user_name_main}>
                      ...
                      >
                        ...
                        <Text style={styles._post_user_name}>
                          {v.postUserName}
                        </Text>
                      </View>
                      <Text style={styles._address}>{v.postUserAddress}</Text>
                    </View>
                    <View style={styles._time_main}>
                      <TouchableOpacity
                        style={{ flexDirection: "row", alignItems: "center" }}
                      >
                        <Text>{v.postTime}</Text>
                        <EvilIcons
                          name="chevron-down"
                          size={24}
                          color="black"
                  ...
                  <View style={styles._like_counter_main}>
                    ...
                    <Text style={styles._like_counter_show}>
                      {v.likeCounter}
                    </Text>
                  </View>
